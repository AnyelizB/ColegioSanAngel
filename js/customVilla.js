...
//----------------------------------- Document ready -----------------------------------//
	   ...
	   // Contact form
			...
			if (!$.trim($(this).val())) { //if this field is empty 
			  ...
			  $("#contact_results").html('<br><div class="alert alert-danger">*Todos los campos son requeridos*.</div>').show();
			...
			if ($(this).attr("type") === "email" && !email_reg.test($.trim($(this).val()))) {
				$(this).css('border-color', '#e44747'); 
				$("#contact_results").html('<br><div class="alert alert-danger">El correo electrónico es requerido.</div>').show();
				proceed = false; //set do not proceed flag				
			}
			});
