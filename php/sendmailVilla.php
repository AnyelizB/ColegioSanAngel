...
if($_POST)
{
	$to_email = "col.sanangel@gmail.com"; //Recipient email, Replace with own email here
	...
	if(!$send_mail)
	{
		...
		$output = json_encode(array('type'=>'error', 'text' => '<p>Mensaje no enviado! Por favor revisar contenido PHP.</p>'));
		die($output);
	}else{
